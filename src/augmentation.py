...
# Dataset-specific statistics over the train split, computed by prepare_data.py
# (see data/norm_stats.json). Used for the scratch CNNs trained from random init.
DATASET_MEAN = (0.4876, 0.4538, 0.4196)
DATASET_STD = (0.2514, 0.2589, 0.2716)
